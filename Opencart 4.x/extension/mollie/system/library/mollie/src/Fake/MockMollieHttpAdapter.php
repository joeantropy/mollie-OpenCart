...
use MollieVendor\PHPUnit\Framework\Assert as PHPUnit;
use MollieVendor\Psr\Http\Client\NetworkExceptionInterface;
...
class MockMollieHttpAdapter implements HttpAdapterContract
{
     ...
     */
    private function getResponse(string $requestClass, PendingRequest $pendingRequest) : \Mollie\Api\Fake\MockResponse
    {
        ...
        if (!$mockedResponse instanceof \Mollie\Api\Fake\SequenceMockResponse) {
            $this->forgetRequest($requestClass);
