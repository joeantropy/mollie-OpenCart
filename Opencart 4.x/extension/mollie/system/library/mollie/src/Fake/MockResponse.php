...
class MockResponse
{
    ...
    {
        return (new \Mollie\Api\Fake\ErrorResponseBuilder($status, $title, $detail, $field))->create();
    }
    public static function list(string $resourceKey) : \Mollie\Api\Fake\ListResponseBuilder
    {
        return new \Mollie\Api\Fake\ListResponseBuilder($resourceKey);
    }
    public static function resource(string $resourceKey) : \Mollie\Api\Fake\ResourceResponseBuilder
    {
        return new \Mollie\Api\Fake\ResourceResponseBuilder($resourceKey);
    }
    ...
    public function body() : string
    {
        ...
        /** @var string $contents */
        $contents = \Mollie\Api\Fake\FakeResponseLoader::load($body);
