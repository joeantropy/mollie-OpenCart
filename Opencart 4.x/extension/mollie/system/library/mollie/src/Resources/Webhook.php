 ...
 */
class Webhook extends \Mollie\Api\Resources\BaseResource
{
    use HasMode;
    /**
     ...
     */
    public function update(array $data = []) : \Mollie\Api\Resources\Webhook
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function test() : \Mollie\Api\Resources\AnyResource
    {
        /** @var AnyResource */
