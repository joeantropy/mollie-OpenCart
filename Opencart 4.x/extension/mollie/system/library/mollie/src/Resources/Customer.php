...
class Customer extends \Mollie\Api\Resources\BaseResource
{
     ...
     * @throws ApiException
     */
    public function update() : ?\Mollie\Api\Resources\Customer
    {
    ...
    {
        return $this->mandates()->contains(fn(\Mollie\Api\Resources\Mandate $mandate) => $mandate->isValid());
    }
    /**
    ...
    {
        return $this->mandates()->contains(fn(\Mollie\Api\Resources\Mandate $mandate) => $mandate->isValid() && $mandate->method === $method);
    }
}
