 ...
 */
class Client extends \Mollie\Api\Resources\BaseResource implements EmbeddedResourcesContract
{
    /**
    ...
    {
        return ['organization' => \Mollie\Api\Resources\Organization::class, 'onboarding' => \Mollie\Api\Resources\Onboarding::class];
    }
}
