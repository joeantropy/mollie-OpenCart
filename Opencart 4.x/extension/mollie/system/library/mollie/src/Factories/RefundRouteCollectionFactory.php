...
class RefundRouteCollectionFactory extends \Mollie\Api\Factories\Factory
{
    public function create() : DataCollection
    {
        $refundRoutes = \array_map(function ($item) {
            ...
            return new RefundRoute(\Mollie\Api\Factories\MoneyFactory::new(Arr::get($item, 'amount'))->create(), Arr::get($item, 'source.organizationId'));
        }, $this->get());
