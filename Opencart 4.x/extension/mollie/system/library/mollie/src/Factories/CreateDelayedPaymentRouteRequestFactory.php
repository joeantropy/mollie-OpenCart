...
class CreateDelayedPaymentRouteRequestFactory extends \Mollie\Api\Factories\RequestFactory
{
    ...
    public function create() : CreateDelayedPaymentRouteRequest
    {
        ...
        return new CreateDelayedPaymentRouteRequest($this->paymentId, $this->transformFromPayload('amount', fn($item) => \Mollie\Api\Factories\MoneyFactory::new($item)->create()), $destination);
    }
}
