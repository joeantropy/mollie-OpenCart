...
class PendingRequest
{
    ...
    protected \Mollie\Api\Http\Request $request;
    ...
    public function __construct(Connector $connector, \Mollie\Api\Http\Request $request)
    {
     ...
     */
    public function executeResponseHandlers(\Mollie\Api\Http\Response $response)
    {
