...
class GetPaginatedPaymentLinkPaymentsRequest extends \Mollie\Api\Http\Requests\SortablePaginatedRequest implements IsIteratable, SupportsTestmodeInQuery
{
