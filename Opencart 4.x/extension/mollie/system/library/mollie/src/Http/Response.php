...
class Response
{
    ...
    protected \Mollie\Api\Http\PendingRequest $pendingRequest;
    protected ?Throwable $senderException = null;
    /**
     * The decoded JSON response.
     */
    protected ?\stdClass $decoded = null;
    public function __construct(ResponseInterface $psrResponse, RequestInterface $psrRequest, \Mollie\Api\Http\PendingRequest $pendingRequest, ?Throwable $senderException = null)
    {
    ...
    public function getPendingRequest() : \Mollie\Api\Http\PendingRequest
    {
        return $this->pendingRequest;
    }
    public function getRequest() : \Mollie\Api\Http\Request
    {
    ...
    {
        return $this->status() === \Mollie\Api\Http\ResponseStatusCode::HTTP_UNPROCESSABLE_ENTITY;
    }
