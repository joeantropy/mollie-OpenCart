...
class MandateEndpointCollection extends \Mollie\Api\EndpointCollection\EndpointCollection
{
    /**
    ...
    public function pageForId(string $customerId, ?string $from = null, ?int $limit = null, $testmode = \false) : MandateCollection
    {
        ...
        return $this->send((new GetPaginatedMandateRequest($customerId, $from, $limit))->test($testmode));
    }
    /**
     ...
     */
    public function iteratorFor(Customer $customer, ?string $from = null, ?int $limit = null, $testmode = \false, bool $iterateBackwards = \false) : LazyCollection
    {
     ...
     * @param  bool  $iterateBackwards  Set to true for reverse order iteration (default is false).
     */
    public function iteratorForId(string $customerId, ?string $from = null, ?int $limit = null, $testmode = \false, bool $iterateBackwards = \false) : LazyCollection
    {
        $testmode = Utility::extractBool($testmode, 'testmode', \false);
        return $this->send((new GetPaginatedMandateRequest($customerId, $from, $limit))->useIterator()->setIterationDirection($iterateBackwards)->test($testmode));
    }
}
