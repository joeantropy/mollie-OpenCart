...
class WebhookEventMapper
{
    ...
    public function processPayload($payload) : BaseEvent
    {
        ...
        return $this->resolveEvent(Arr::get($payload, 'id'), Arr::get($payload, 'type'), Arr::get($payload, 'entityId'), Utility::transform(Arr::get($payload, 'createdAt'), fn(string $timestamp) => new DateTime($timestamp), DateTime::class), (object) (Arr::get($payload, '_links') ?? []), $this->createWebhookEntityFromPayload($payload));
    }
    /**
     ...
     * @return BaseEvent
     */
    public function resolveEvent(string $id, string $type, string $entityId, DateTime $createdAt, object $links, ?\Mollie\Api\Webhooks\WebhookEntity $entity = null) : BaseEvent
    {
        ...
        return new $class($id, $entityId, $createdAt, $links, $entity);
    }
     ...
     */
    private function createWebhookEntityFromPayload(array $payload) : ?\Mollie\Api\Webhooks\WebhookEntity
    {
        ...
        $entity = \Mollie\Api\Webhooks\WebhookEntity::create($entityData);
        return $entity;
    }
}
